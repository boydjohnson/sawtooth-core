...
use cpython::{self, PyClone};
use execution::{execution_platform::ExecutionPlatform, py_executor::PyExecutor};
use gossip::permission_verifier::PyPermissionVerifier;
use journal::chain_ffi::PyBlockStore;
use journal::{
    block_manager::BlockManager,
    block_store::{BatchIndex, BlockStore, TransactionIndex},
...
pub unsafe extern "C" fn block_validator_new(
    ...
    check_null!(block_manager_ptr, block_status_store_ptr, view_factory_ptr);
